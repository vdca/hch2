...
d %>% write_csv("../data/hch2_sequences.csv")
d <- read_csv("../data/hch2_sequences.csv", col_types = "iicicc") 
...
dcomp <- readRDS("../data/hch2_compression.rds")
...
#' **output of this section can be loaded below
...
# saveRDS(stims, "../data/hch2_baseline.rds")
# stims <- readRDS("../data/hch2_baseline.rds")
...
# saveRDS(base.prob, "../data/hch2_baseprob.rds")
...
# smoothing parameter when using the 1,000,000 baseline
...
#' convert 1M-baseline to feature-sequences
...
# saveRDS(base2, "../data/hch2_baseline_features.rds")
